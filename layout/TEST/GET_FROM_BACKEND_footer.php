  ...
  <div class="container">
    <div class="footerGrid">
      <div class="col">
        ...
        <div class="colInner">
          <ul class="contacts">
            <li><a href="mailto:info@nuxgame.com">info@nuxgame.com</a></li>
          </ul>
        ...
        <div class="colInner margin">
          <p class="copyWrites">The website is owned and operated by Nuxgen B.V., with registration number 153051 and
            registered address at Fransche Bloemweg 4, Curacao.</p>
          <p class="copyWrites">© 2021 Nuxgen B.V. All rights reserved.</p>
        </div>
      </div>
      <div class="col">
        <h4>MENU</h4>
      ...
      <div class="col flex">
        <div class="divWrap">
          <h4>GUIDES</h4>
          <ul class="footerNav">
            <li><a href="/terms-and-conditions">How to Start an Online
                Casino</a>
            </li>
            <li><a href="/privacy-policy">How to Start an Online Betting
                Business</a></li>
          </ul>
        </div>
        <div class="divWrap">
          <ul class="footerAppWrap">
            <li>
              <div id="apg-be5b7d95-1bfc-4f92-b5e1-ec5c7ae3eba6" data-apg-seal-id="be5b7d95-1bfc-4f92-b5e1-ec5c7ae3eba6" data-apg-image-size="128" data-apg-image-type="basic-small">
                <div style="display: block;position: relative;overflow: hidden;max-width: 128px;min-width: 32px; background-image: url(https://be5b7d95-1bfc-4f92-b5e1-ec5c7ae3eba6.snippet.antillephone.com/54f396e0-b046-49b1-9cb3-0c69281d7ea9-beacon.png);">
                  <a target="_blank" rel="nofollow, noopener" href="https://validator.antillephone.com/validate?domain=nuxsite1.nuxbet.com&amp;seal_id=30592353974c576df56a0705c9e615cd62614b633608f72cc71b2b1a66ab6cfa1309573cbb3e119cee9aea6d48bb15a3&amp;stamp=9f0610c5bace5eec362aa75f16c39d53"><img alt="" style="width: 100%; height: auto" src="https://be5b7d95-1bfc-4f92-b5e1-ec5c7ae3eba6.snippet.antillephone.com/sealassets/9f0610c5bace5eec362aa75f16c39d53-nuxsite1.nuxbet.com-30592353974c576df56a0705c9e615cd62614b633608f72cc71b2b1a66ab6cfa1309573cbb3e119cee9aea6d48bb15a3-c2VhbC5wbmc%3D?status=valid"></a>
                </div>
              </div>
            </li>
          </ul>
          <div class="scriptContent">
            ...
            <a target="_blank" rel="nofollow" href="https://www.dmca.com/Protection/Status.aspx?ID=7218619b-9b4f-4997-82c8-a9a7803a98d8&amp;refurl=https://test.nuxapi.com/" title="DMCA.com Protection Status" class="dmca-badge">
              <img rel="nofollow" src="https://images.dmca.com/Badges/_dmca_premi_badge_4.png?ID=7218619b-9b4f-4997-82c8-a9a7803a98d8" alt="DMCA.com Protection Status"></a>
      ...
      <p class="copyWrites mobile">
        The website is owned and operated by Nuxgen B.V., with registration number 153051 and registered address at
        Fransche Bloemweg 4, Curacao.
      </p>
      <p class="copyWrites mobile">
        © 2021 Nuxgen B.V. All rights reserved.
      </p>
    </div>
  </div>
  <style>
    ...
    .fixedWraper {
      z-index: 10;
      background: url(https://test.nuxapi.com/img/header_bg.png) no-repeat;
    ...
    .fixedWraper:after {
      content: "";
      height: 100%;
      background: linear-gradient(332.47deg, rgba(3, 0, 58, .15) 14.92%, rgba(149, 151, 255, .15) 97.67%);
    ...
    .fixedWraper.mainHeader.hideAfter .navigationWrapper:after {
      height: 100%;
      transition: all 1s;
    }
    ...
    .mobileNavBtnWrapper .mobileNavBtn {
      background: url(https://test.nuxapi.com/img/icons/Menu.svg) no-repeat 50%;
      border: none;
      outline: none;
      cursor: pointer;
      transition: all .3s;
    ...
    .icon {
      ...
      background: url(https://test.nuxapi.com/img/icons/arrow_up.svg) no-repeat 50%;
      width: 8px;
      height: 7px;
      transition: all .3s;
    }
    ...
    .nav>li a:hover+.icon {
      background: url(https://test.nuxapi.com/img/icons/arrow_up_hover.svg);
      transition: all .3s;
    }
    ...
    .nav .navDropDown {
      ...
      box-sizing: border-box;
      background: url(https://test.nuxapi.com/img/dropDown_bg.png) no-repeat 50%;
      background-size: cover;
    }
    ...
    .nav .navDropDown:after {
      ...
      width: 100%;
      height: 100%;
      background: linear-gradient(332.47deg, rgba(3, 0, 58, .3) 14.92%, rgba(149, 151, 255, .3) 97.67%);
      -webkit-backdrop-filter: blur(30px);
      backdrop-filter: blur(30px);
    }
    ...
    .nav .navDropDown li a:after {
      ...
      width: 12px;
      height: 12px;
      background: url(https://test.nuxapi.com/img/icons/arrow_drop.svg) no-repeat 50%;
      opacity: 0;
      transition: all .3s;
    }
    ...
    .langSwitcherWrapper:hover .currentLang:after {
      background: url(https://test.nuxapi.com/img/icons/arrow_up_hover.svg) no-repeat 50%;
      transition: all .3s;
    }
    ...
    @media (min-width:992px) {
      ...
      .nav>li:first-child:hover .navDropDown,
    ...
    @media (max-width:991px) {
      .fixedWraper {
        background: url(https://test.nuxapi.com/img/mobStatick_bg.png) no-repeat;
        background-size: cover;
      }
      ...
      .fixedWraper .mainNav {
        background: url(https://test.nuxapi.com/img/mobBgLight_full.png) no-repeat;
        background-size: cover;
      ...
      .nav>li:after {
        ...
        height: 1px;
        width: 100%;
        background: linear-gradient(90deg, rgba(124, 124, 255, .5), rgba(124, 124, 255, 0) 74.44%);
      }
      ...
      .mainNav .langSwitcherWrapper:hover .langSwitcher {
        padding: 25px 0;
        height: 240px;
        transition: all .3s;
      }
    ...
    * {
    ...
    .mainScreen {
      position: relative;
      min-height: 1600px;
      background: url(https://test.nuxapi.com/img/back_without-sphere1.png) no-repeat top;
    ...
    .whyUs .innerRow .innerItem.numbs.mob .mobColor .item:first-child .numb,
    ...
    .whyUs .innerRow .innerItem.numbs .item .image {
      ...
      opacity: 0;
      z-index: -1;
      transition: opacity .3s .3s, top .5s;
    }

    .whyUs .innerRow .innerItem.numbs .item:hover .image {
      opacity: 1;
      top: -50px;
      transition: opacity .3s, top .5s .1s;
    }

    .whyUs .innerRow .innerItem.numbs .item:first-child .numb,
    ...
    @media (max-width:768px) {
      ...
      .solutionsWrapper .table__cell img {
        width: 100%;
        height: 110%;
        left: 0;
        -o-object-fit: cover;
    ...
    @font-face {
      ...
      font-weight: 400;
      font-style: normal;
      src: url(https://test.nuxapi.com/assets/css/fonts/slick.eot);
      src: url(https://test.nuxapi.com/assets/css/fonts/slick.eot#iefix) format('embedded-opentype'), url(https://test.nuxapi.com/assets/css/fonts/slick.woff) format('woff'), url(https://test.nuxapi.com/assets/css/fonts/slick.ttf) format('truetype'), url(https://test.nuxapi.com/assets/css/fonts/slick.svg#slick) format('svg');
    }
    ...
    /*! CSS Used from: https://test.nuxapi.com/assets/css/main.lib.css?v=5 */
    div,
    h2,
    img,
    p,
    ...
    /*! CSS Used from: https://test.nuxapi.com/css/main_new/main_new.css?id=b963f5c120d11596820d */
    * {
      margin: 0;
      padding: 0;
      box-sizing: border-box;
    ...
    .readyToStart {
      ...
      min-height: 300px;
      background: url("https://test.nuxapi.com/img/readyToStart.png") no-repeat center;
      background-size: cover;
      position: relative;
    }
    ...
    .readyToStart .animationsWrapper .small_ball {
      ...
      right: 60px;
      top: 50px;
      -webkit-animation: MoveItemsInfinite1 6s linear infinite;
      animation: MoveItemsInfinite1 6s linear infinite;
    }
    ...
    * {
    ...
    .contacts:before {
      ...
      width: 37px;
      height: 25px;
      background: url(https://test.nuxapi.com/img/icons/mail.svg) no-repeat 50%;
    }
    ...
    @media (max-width:768px) {
      ...
      .footerGrid .colInner:last-child {
        display: none;
      }
    ...
    * {
    ...
    /*! CSS Used from: https://unpkg.com/flickity@2/dist/flickity.min.css */
    .flickity-enabled {
      position: relative;
    }
    ...
    .fixedWraper::after {
      ...
      width: 100%;
      height: 100%;
      background: linear-gradient(332.47deg, rgba(3, 0, 58, 0.15) 14.92%, rgba(149, 151, 255, 0.15) 97.67%);
      -webkit-backdrop-filter: blur(30px);
      backdrop-filter: blur(30px);
    }
    ...
    .navigationWrapper::after {
      ...
      left: 0px;
      top: 0;
      background: url(https://test.nuxapi.com/img/logo_light.svg) no-repeat center;
    ...
    .mobileNavBtnWrapper .mobileNavBtn {
      background: url(https://test.nuxapi.com/img/icons/Menu.svg) no-repeat center;
      border: none;
      outline: none;
      cursor: pointer;
      transition: all 0.3s;
    ...
    .icon {
      ...
      margin-left: 10px;
      transform: rotate(180deg);
      background: url(https://test.nuxapi.com/img/icons/arrow_up.svg) no-repeat center;
      width: 8px;
      height: 7px;
      transition: all 0.3s;
    }
    ...
    .nav .navDropDown {
      ...
      box-sizing: border-box;
      background: url(https://test.nuxapi.com/img/dropDown_bg.png) no-repeat center;
      background-size: cover;
    }
    ...
    .nav .navDropDown::after {
      ...
      width: 100%;
      height: 100%;
      background: linear-gradient(332.47deg, rgba(3, 0, 58, 0.3) 14.92%, rgba(149, 151, 255, 0.3) 97.67%);
      -webkit-backdrop-filter: blur(30px);
      backdrop-filter: blur(30px);
    }
    ...
    .nav .navDropDown li a::after {
      ...
      width: 12px;
      height: 12px;
      background: url(https://test.nuxapi.com/img/icons/arrow_drop.svg) no-repeat center;
      opacity: 0;
      transition: all 0.3s;
    }
    ...
    .langSwitcherWrapper:hover .currentLang::after {
      background: url(https://test.nuxapi.com/img/icons/arrow_up_hover.svg) no-repeat center;
      transition: all 0.3s;
    }
    ...
    * {
    ...
    .contacts:before {
      ...
      width: 37px;
      height: 25px;
      background: url("https://test.nuxapi.com/img/icons/mail.svg") no-repeat center;
    }
    ...
    .btnTotop .animArrow {
      ...
      width: 18px;
      height: 18px;
      background: url(https://test.nuxapi.com/img/icons/toTopDark.png) no-repeat center;
    ...
    .btnTotop.light .animArrow {
      background: url(https://test.nuxapi.com/img/icons/toTop.png) no-repeat center;
    }
    ...
    .successCookie .hideCookieBtn {
      ...
      width: 20px;
      height: 20px;
      background: url(https://test.nuxapi.com/images/cross.svg?0a42983d897bddc7ebe2ca96cfaa380d) no-repeat center;
      border: none;
      opacity: 1;
      visibility: visible;
      cursor: pointer;
    ...
    .facts {
      ...
      background: url(https://test.nuxapi.com/img/facts.png) no-repeat center;
      background-size: cover;
      overflow: hidden;
    }
    ...
    .facts .innerRow h2 span:last-child {
      padding-left: 61px;
    }
    ...
    .numbers-slider__slider-light-gradient:before {
      ...
      height: 100%;
      content: "";
      background-image: url(https://test.nuxapi.com/img/glaim1.svg);
      background-repeat: no-repeat;
    ...
    .zohoWrapper #crmWebToEntityForm.zcwf_lblRight {
      background: linear-gradient(332.47deg, rgba(2, 0, 40, 0.3) 14.92%, rgba(173, 175, 255, 0.3) 97.67%);
      border: 1px solid rgba(255, 255, 255, 0.2);
      -webkit-backdrop-filter: blur(30px);
      backdrop-filter: blur(30px);
    }
    ...
    .zohoWrapper .zcwf_lblRight .zcwf_col_fld input[type=text]::-moz-placeholder,
    .zohoWrapper .zcwf_lblRight .zcwf_col_fld textarea::-moz-placeholder,
    .zohoWrapper .zcwf_lblRight .zcwf_col_fld select::-moz-placeholder,
    .zohoWrapper .zcwf_lblRight .select2-container::-moz-placeholder {
      font-size: 14px;
      font-family: "Montserrat", sans-serif;
      color: #FFFFFF;
    }

    .zohoWrapper .zcwf_lblRight .zcwf_col_fld input[type=text]:-ms-input-placeholder,
    .zohoWrapper .zcwf_lblRight .zcwf_col_fld textarea:-ms-input-placeholder,
    .zohoWrapper .zcwf_lblRight .zcwf_col_fld select:-ms-input-placeholder,
    .zohoWrapper .zcwf_lblRight .select2-container:-ms-input-placeholder {
      font-size: 14px;
      font-family: "Montserrat", sans-serif;
      color: #FFFFFF;
    }
    ...
    .zoho_btn_close {
      ...
      width: 14px;
      height: 14px;
      background-image: url(https://test.nuxapi.com/img/icons/cross.svg);
      background-position: center center, center center;
      background-repeat: no-repeat;
      background-size: auto;
      border: none;
    ...
    @media (max-width: 650px) {
      ...
      .products .prod_slider .prod_slide {
        flex-direction: column-reverse;
      }

      .products .prod_slider .prod_img {
        width: 80%;
        top: 0;
      }

      .products .prod_slider .prod_info {
        max-width: 100%;
        width: 100%;
        padding: 0;
      }
    ...
    /*! CSS Used from: https://test.nuxapi.com/_debugbar/assets/stylesheets?v=1644393152&theme=auto */
    .phpdebugbar-fa {
      display: inline-block;
    ...
    div.phpdebugbar-minimized a.phpdebugbar-maximize-btn {
      display: block;
    }
    ...
    div.phpdebugbar-openhandler table th:nth-child(1),
    div.phpdebugbar-openhandler table th:nth-child(2),
    div.phpdebugbar-openhandler table th:nth-child(4),
    div.phpdebugbar-openhandler table th:nth-child(5) {
      width: 5% !important;
      white-space: nowrap;
    }
    ...
    div.phpdebugbar-openhandler table th:nth-child(3) {
    ...
    /*! CSS Used from: https://css.zohocdn.com/salesiq/styles/floatbutton11_f2633c317a38e36bbe0e23bfa4a3e9fa_.css */
    .zsiq_float,
    .zsiq_float * {
    ...
    .siqico-chat:before {
      font-family: siq-float !important;
      speak: none;
      font-style: normal;
      font-weight: 400;
      font-variant: normal;
    ...
    .zsiq_theme11 .zsiq_flt_rel:before {
      ...
      bottom: -5px;
      right: -5px;
      border-right: 5px solid #328a59;
      border-left: 5px solid transparent;
      border-top: 5px solid transparent;
      border-bottom: 5px solid #328a59;
    ...
    /*! CSS Used from: https://css.zohocdn.com/salesiq/styles/floatbuttonpostload_71312d4493106c0a9df602bffd5c64b5_.css */
    ...
    /*! CSS Used from: Embedded */
    .zsiq_theme11 .zsiq_flt_rel {
      background-color: #4545ba !important;
    }

    .zsiq_theme11 .zsiq_flt_rel::after,
    .zsiq_theme11 .zsiq_flt_rel::before {
      border-right: 5px solid #4545ba !important;
      border-bottom: 5px solid #4545ba;
    }
    ...
    @font-face {
      font-family: siq-float;
      src: url(https://css.zohocdn.com/salesiq/styles/fonts/float/float_bc86d637487425e4b937faa68fab9bd9_.eot);
    ...
    @font-face {
      font-family: siq;
      src: url(https://css.zohocdn.com/salesiq/styles/fonts/float/siq_dad92e0c81c4371e8d39a27bf949207d_.eot);
      src: url(https://css.zohocdn.com/salesiq/styles/fonts/float/siq_dad92e0c81c4371e8d39a27bf949207d_.eot) format('embedded-opentype'), url(https://css.zohocdn.com/salesiq/styles/fonts/float/siq_df7a33e7f9075cf8e624bd35984c7262_.ttf) format('truetype'), url(https://css.zohocdn.com/salesiq/styles/fonts/float/siq_21ba57f7712af89c9cdd6b098f9f0d4c_.woff) format('woff'), url(https://css.zohocdn.com/salesiq/styles/fonts/float/siq_3bb99980fd4918ca221e5651e3562394_.svg) format('svg');
      font-weight: 400;
      font-style: normal;
      font-display: swap;
    }
